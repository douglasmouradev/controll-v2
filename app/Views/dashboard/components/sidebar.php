...
<aside id="sidebar" class="w-64 bg-blue-900 text-white h-screen fixed left-0 top-0 shadow-lg overflow-y-auto transform -translate-x-full transition-transform duration-300 z-50">
	...
	<nav class="mt-6">
		...
		<button class="sidebar-menu-item w-full text-left px-6 py-3 hover:bg-blue-800 transition-colors border-l-4 border-transparent hover:border-blue-400" data-tab="inventario">
			<div class="flex items-center">
				<svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20">
					<path d="M4 3a2 2 0 00-2 2v2h16V5a2 2 0 00-2-2H4zM18 9H2v6a2 2 0 002 2h12a2 2 0 002-2V9zm-11 2h6a1 1 0 110 2H7a1 1 0 110-2z"/>
				</svg>
				<span class="font-medium">Projeto RFID</span>
			</div>
			<p class="text-blue-200 text-xs mt-1 ml-8">Itens por categoria</p>
		</button>
	</nav>
