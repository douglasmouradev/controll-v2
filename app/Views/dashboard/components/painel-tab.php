...
<div id="tab-painel" class="tab-content px-4 md:px-0" data-user-id="<?php echo (int) $user['id']; ?>">
	...
	<div class="mb-8 flex items-center justify-between">
		...
		<div class="flex gap-2">
			<button id="btn-abrir-chamado" class="bg-blue-700 text-white px-6 py-3 rounded hover:bg-blue-800 font-semibold">Abrir Chamado</button>
			<?php if ($user['role'] === 'admin'): ?>
				<button id="btn-global-credits-ticket" class="bg-purple-700 text-white px-4 py-3 rounded hover:bg-purple-800 font-semibold text-sm" title="Ajustar Créditos Ticket para todos os usuários">Créditos Ticket</button>
				<button id="btn-global-credits-daily" class="bg-indigo-700 text-white px-4 py-3 rounded hover:bg-indigo-800 font-semibold text-sm" title="Ajustar Créditos Diária para todos os usuários">Créditos Diária</button>
				<button id="btn-global-credits-project" class="bg-orange-700 text-white px-4 py-3 rounded hover:bg-orange-800 font-semibold text-sm" title="Ajustar Créditos Projeto para todos os usuários">Créditos Projeto</button>
			<?php endif; ?>
		</div>
	</div>
...
<dialog id="credit-extract-modal" class="rounded-lg w-11/12 max-w-2xl p-0">
	...
	<div class="p-6 max-h-96 overflow-y-auto">
		...
		<!-- Histórico -->
		<div>
			<h3 class="font-semibold text-gray-700 mb-3">Histórico</h3>
			<div id="extract-history" class="space-y-2">
