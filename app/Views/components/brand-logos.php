...
<div class="<?php echo htmlspecialchars($wrapperClass, ENT_QUOTES, 'UTF-8'); ?>">
	<img src="<?php echo htmlspecialchars($controllSrc, ENT_QUOTES, 'UTF-8'); ?>" class="<?php echo htmlspecialchars($controllClass, ENT_QUOTES, 'UTF-8'); ?>" alt="Controll IT" width="152" height="40">
	<?php if ($showDivider): ?>
		<?php if ($variant === 'auth'): ?>
