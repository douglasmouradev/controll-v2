<div class="auth-card">
	...
	<div class="px-8 pb-8">
		<div class="bg-amber-50 text-amber-900 border border-amber-100 rounded-xl px-4 py-3 text-sm">
			Os links de cadastro expiram em 24 horas. Os registros já enviados permanecem salvos no sistema.
		</div>
		<p class="text-sm text-slate-500 mt-4">Solicite um novo link de 4 dígitos ao responsável pelo projeto.</p>
	</div>
</div>
