document.addEventListener('DOMContentLoaded', function () {
	...
	form.addEventListener('submit', async (event) => {
		...
		try {
			...
			formData.set('serie_antena', document.getElementById('sdwan-public-serie-antena')?.value || '');
			formData.set('serie_acupad', document.getElementById('sdwan-public-serie-acupad')?.value || '');
			formData.set('setor', document.getElementById('sdwan-public-setor')?.value || '');
